...
OriginbotBase::OriginbotBase(std::string nodeName) : Node(nodeName)
{
    ...
    // 创建控制蜂鸣器和LED的服务
    buzzer_service_ = this->create_service<originbot_msgs::srv::OriginbotBuzzer>("originbot_buzzer", &OriginbotBase::buzzer_callback, this, _1);
    led_service_ = this->create_service<originbot_msgs::srv::OriginbotLed>("originbot_led", &OriginbotBase::led_callback, this, _1);
